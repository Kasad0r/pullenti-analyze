...
public class NumberingHelper {
    ...
    public static int calcDelta(InstrToken1 prev, InstrToken1 next, boolean canSubNumbers) {
        ...
        if ((prev.numbers.size() - 1) == next.numbers.size() && prev.numbers.size() > 1) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11450 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1451 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 2), 0, null, wrapn11450);
            n1 = (wrapn11450.value != null ? wrapn11450.value : 0);
            if (!inoutres1451) {
        ...
        if ((prev.numbers.size() - 2) == next.numbers.size() && prev.numbers.size() > 2) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11452 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1453 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 3), 0, null, wrapn11452);
            n1 = (wrapn11452.value != null ? wrapn11452.value : 0);
            if (!inoutres1453) 
                return 0;
            if ((n1 + 1) != n2) 
                return 0;
        ...
        if ((prev.numbers.size() - 3) == next.numbers.size() && prev.numbers.size() > 3) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11454 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1455 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 4), 0, null, wrapn11454);
            n1 = (wrapn11454.value != null ? wrapn11454.value : 0);
            if (!inoutres1455) 
                return 0;
            if ((n1 + 1) != n2) 
                return 0;
    ...
    public static void createNumber(FragToken owner, InstrToken1 itok) {
        if (itok.numBeginToken == null || itok.numEndToken == null) 
            return;
        FragToken num = FragToken._new1456(itok.numBeginToken, itok.numEndToken, com.pullenti.ner.instrument.InstrumentKind.NUMBER, true, itok);
    ...
    public static java.util.ArrayList<String> createDiap(String s1, String s2) {
        ...
        if (s2.startsWith(s1)) {
            ...
            if (((i + 1) < s2.length()) && s2.charAt(i) == '.' && Character.isDigit(s2.charAt(i + 1))) {
                com.pullenti.unisharp.Outargwrapper<Integer> wrapn21457 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1458 = com.pullenti.unisharp.Utils.parseInteger(s2.substring(i + 1), 0, null, wrapn21457);
                n2 = (wrapn21457.value != null ? wrapn21457.value : 0);
                if (inoutres1458) {
        ...
        if ((((i = s1.lastIndexOf('.')))) > 0) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11461 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1462 = com.pullenti.unisharp.Utils.parseInteger(s1.substring(i + 1), 0, null, wrapn11461);
            n1 = (wrapn11461.value != null ? wrapn11461.value : 0);
            if (!inoutres1462) 
                return null;
            if (!s2.startsWith(pref)) 
                return null;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn21459 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1460 = com.pullenti.unisharp.Utils.parseInteger(s2.substring(i + 1), 0, null, wrapn21459);
            n2 = (wrapn21459.value != null ? wrapn21459.value : 0);
            if (!inoutres1460) 
                return null;
        }
        else {
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11465 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1466 = com.pullenti.unisharp.Utils.parseInteger(s1, 0, null, wrapn11465);
            n1 = (wrapn11465.value != null ? wrapn11465.value : 0);
            if (!inoutres1466) 
                return null;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn21463 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1464 = com.pullenti.unisharp.Utils.parseInteger(s2, 0, null, wrapn21463);
            n2 = (wrapn21463.value != null ? wrapn21463.value : 0);
            if (!inoutres1464) 
                return null;
        }
        if (n2 <= n1) 
