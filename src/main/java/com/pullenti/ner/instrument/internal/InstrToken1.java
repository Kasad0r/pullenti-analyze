...
public class InstrToken1 extends com.pullenti.ner.MetaToken {
    ...
    public static InstrToken1 parse(com.pullenti.ner.Token t, boolean ignoreDirectives, FragToken cur, int lev, InstrToken1 prev, boolean isCitat, int maxChar, boolean canBeTableCell) {
        ...
        if (t.isChar('(')) {
            ...
            if (fr != null) 
                edt = _new1430(fr.getBeginToken(), fr.getEndToken(), Types.EDITIONS);
            else {
                com.pullenti.ner.Token t2 = _createEdition(t);
                if (t2 != null) 
                    edt = _new1430(t, t2, Types.EDITIONS);
            }
            if (edt != null) {
        ...
        InstrToken1 res = _new1432(t0, t, true);
        ...
        if (dt == null && (((t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (t.getReferent() instanceof com.pullenti.ner.instrument.InstrumentParticipant)))) {
            dt = com.pullenti.ner.decree.internal.DecreeToken._new815(t, t, com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER);
        ...
        if (t.isValue("КОНСУЛЬТАНТПЛЮС", null) || t.isValue("ГАРАНТ", null)) {
            ...
            if (t1 != null && ((t1.isValue("ПРИМЕЧАНИЕ", null) || ok))) {
                if (t1.getNext() != null && t1.getNext().isChar('.')) 
                    t1 = t1.getNext();
                InstrToken1 re = _new1430(t, t1, Types.COMMENT);
        ...
        if (checkComment > 0 || t.isValue("О", "ПРО")) {
            ...
            if (ok) {
                InstrToken1 cmt = _new1430(t, t1, Types.COMMENT);
        ...
        String val = null;
        com.pullenti.unisharp.Outargwrapper<String> wrapval1441 = new com.pullenti.unisharp.Outargwrapper<String>();
        com.pullenti.ner.Token tt2 = _checkDirective(t, wrapval1441);
        val = wrapval1441.value;
        if (tt2 != null) {
            if (tt2.isNewlineAfter() || ((tt2.getNext() != null && ((tt2.getNext().isCharOf(":") || ((tt2.getNext().isChar('.') && tt2 != t)))) && ((tt2.getNext().isNewlineAfter() || t.chars.isAllUpper()))))) 
                return _new1436(t, (tt2.isNewlineAfter() ? tt2 : tt2.getNext()), Types.DIRECTIVE, val);
        }
        if ((lev < 3) && t != null) {
            if (t.isValue("СОДЕРЖИМОЕ", "ВМІСТ") || t.isValue("СОДЕРЖАНИЕ", "ЗМІСТ") || t.isValue("ОГЛАВЛЕНИЕ", "ЗМІСТ")) {
                ...
                if (t11 != null && t11.isNewlineBefore()) {
                    InstrToken1 first = parse(t11, ignoreDirectives, null, lev + 1, null, false, 0, false);
                    if (first != null && (first.getLengthChar() < 4)) 
                        first = parse(first.getEndToken().getNext(), ignoreDirectives, null, lev + 1, null, false, 0, false);
                    ...
                    if (first != null) {
                        ...
                        for (tt = first.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                            if (tt.isValue("ТЕРМИНЫ", null)) {
                            }
                            if (tt.isNewlineBefore()) {
                                if ((++cou) > 400) 
                                    break;
                            }
                            InstrToken1 it = parse(tt, ignoreDirectives, null, lev + 1, null, false, 0, false);
                            if (it == null) 
                                break;
                            boolean ok = false;
                            if (first.numbers.size() == 1 && it.numbers.size() == 1) {
                                if (com.pullenti.unisharp.Utils.stringsEq(first.numbers.get(0), it.numbers.get(0))) 
                                    ok = true;
                            }
            ...
            if (tt != null && tt.isCharOf(".)]")) {
                ...
                for (; tt != null; tt = tt.getNext()) {
                    ...
                    if (tt.isNewlineAfter()) {
                        if (ok) 
                            return _new1430(t, tt, Types.COMMENT);
                        break;
                    }
                }
        }
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (t.isNewlineBefore() && t != res.getBeginToken()) {
                ...
                if (t.getNewlinesBeforeCount() == 1 && t.getPrevious() != null && t.getPrevious().chars.isLetter()) {
                    ...
                    if (!isNewLine) {
                        InstrToken1 tes = InstrToken1.parse(t, true, null, 0, null, false, 0, false);
            ...
            if ((t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter()) {
                ...
                if (t.chars.isCapitalUpper() && res.getLengthChar() > 20) {
                    if (t.isValue("РУКОВОДСТВУЯСЬ", null)) {
                        ...
                        InstrToken1 ttt = parse(t, true, null, 0, null, false, 0, false);
            ...
            if (t != res.getBeginToken() && _isFirstLine(t)) 
                break;
            String tmp;
            com.pullenti.unisharp.Outargwrapper<String> wraptmp1438 = new com.pullenti.unisharp.Outargwrapper<String>();
            tt2 = _checkDirective(t, wraptmp1438);
            tmp = wraptmp1438.value;
            if (tt2 != null) {
        ...
        if (res.typ == Types.LINE) {
            if (res.numTyp != NumberTypes.UNDEFINED) {
                ...
                for (String nn : res.numbers) {
                    int vv;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapvv1439 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    boolean inoutres1440 = com.pullenti.unisharp.Utils.parseInteger(nn, 0, null, wrapvv1439);
                    vv = (wrapvv1439.value != null ? wrapvv1439.value : 0);
                    if (inoutres1440) {
    ...
    public static InstrToken1 _new1430(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Types _arg3) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static InstrToken1 _new1432(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.allUpper = _arg3;
        return res;
    }

    public static InstrToken1 _new1436(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Types _arg3, String _arg4) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static InstrToken1 _new1449(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3, Types _arg4) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
