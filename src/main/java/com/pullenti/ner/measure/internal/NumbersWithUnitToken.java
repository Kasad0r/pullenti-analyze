...
public class NumbersWithUnitToken extends com.pullenti.ner.MetaToken {
    ...
    public static java.util.ArrayList<NumbersWithUnitToken> tryParseMulti(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, boolean canOmitNumber, boolean _not) {
        if (t == null || (t instanceof com.pullenti.ner.ReferentToken)) 
            return null;
        if (t.isChar('(')) {
            java.util.ArrayList<NumbersWithUnitToken> res0 = tryParseMulti(t.getNext(), addUnits, false, canOmitNumber);
        ...
        NumbersWithUnitToken mt = tryParse(t, addUnits, canOmitNumber, _not);
        if (mt == null) 
            return null;
        ...
        if ((mt.getWhitespacesAfterCount() < 2) && MeasureHelper.isMultChar(mt.getEndToken().getNext())) {
            NumbersWithUnitToken mt2 = NumbersWithUnitToken.tryParse(mt.getEndToken().getNext().getNext(), addUnits, _not, false);
            if (mt2 != null) {
                NumbersWithUnitToken mt3 = null;
                if ((mt2.getWhitespacesAfterCount() < 2) && MeasureHelper.isMultChar(mt2.getEndToken().getNext())) 
                    mt3 = NumbersWithUnitToken.tryParse(mt2.getEndToken().getNext().getNext(), addUnits, false, false);
                if (mt3 == null) {
        ...
        if ((!mt.isWhitespaceAfter() && MeasureHelper.isMultCharEnd(mt.getEndToken().getNext()) && (mt.getEndToken().getNext().getNext() instanceof com.pullenti.ner.NumberToken)) && mt.units.size() == 0) {
            ...
            if (terms != null && terms.size() > 0) {
                mt.units.add(UnitToken._new1517(mt.getEndToken().getNext(), mt.getEndToken().getNext(), (Unit)com.pullenti.unisharp.Utils.cast(terms.get(0).tag, Unit.class)));
                mt.setEndToken(mt.getEndToken().getNext());
                java.util.ArrayList<NumbersWithUnitToken> res1 = tryParseMulti(mt.getEndToken().getNext(), addUnits, false, false);
                if (res1 != null) {
                    res1.add(0, mt);
                    return res1;
                }
     ...
     * @return 
     */
    public static NumbersWithUnitToken tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, boolean canOmitNumber, boolean _not) {
        if (t == null) 
            return null;
        NumbersWithUnitToken res = _tryParse(t, addUnits, false, canOmitNumber);
        if (res != null) 
            res.not = _not;
        return res;
    }
    ...
    public static NumbersWithUnitToken _tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, boolean second, boolean canOmitNumber) {
        if (t == null) 
            return null;
        while (t != null) {
        ...
        int minMax = 0;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapminMax1523 = new com.pullenti.unisharp.Outargwrapper<Integer>(minMax);
        com.pullenti.ner.Token ttt = _isMinOrMax(t, wrapminMax1523);
        minMax = (wrapminMax1523.value != null ? wrapminMax1523.value : 0);
        if (ttt != null) {
            t = ttt.getNext();
            if (t == null) 
                return null;
        ...
        if (t0.isChar('(')) {
            NumbersWithUnitToken mt0 = _tryParse(t.getNext(), addUnits, false, false);
        ...
        if (tok != null) {
            ...
            if (t != null && t.isChar('(')) {
                ...
                if (uni != null) {
                    ...
                    NumbersWithUnitToken mt0 = _tryParse(t, addUnits, false, canOmitNumber);
        ...
        if (num == null) {
            ...
            if (tt != null) {
                ...
                for (Unit u : UnitsHelper.UNITS) {
                    if (com.pullenti.unisharp.Utils.stringsEq(u.fullnameCyr, unam)) {
                        ...
                        uni.add(UnitToken._new1517(t, t, u));
                        break;
                    }
                }
                if (uni == null) 
                    return null;
                res = _new1519(t0, tt.getEndToken(), _about);
                ...
                if ((uni != null && uni.size() == 1 && uni.get(0).getBeginToken() == uni.get(0).getEndToken()) && uni.get(0).getLengthChar() > 3) {
                    rval = 1.0;
                    res = _new1519(t0, uni.get(uni.size() - 1).getEndToken(), _about);
            ...
            res = _new1519(t0, num.getEndToken(), _about);
        ...
        if (uni == null) {
            ...
            if (uni.size() > 1) {
                ...
                if (((uni1 != null && uni1.get(0).unit == uni.get(0).unit && (uni1.size() < uni.size())) && uni.get(uni1.size()).pow == -1 && uni1.get(uni1.size() - 1).getEndToken().getNext() != null) && uni1.get(uni1.size() - 1).getEndToken().getNext().isCharOf("/\\")) {
                    NumbersWithUnitToken num2 = _tryParse(uni1.get(uni1.size() - 1).getEndToken().getNext().getNext(), addUnits, false, false);
        ...
        if (!second) {
            int iii = 0;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapiii1522 = new com.pullenti.unisharp.Outargwrapper<Integer>(iii);
            ttt = _isMinOrMax(t, wrapiii1522);
            iii = (wrapiii1522.value != null ? wrapiii1522.value : 0);
            if (ttt != null && iii > 0) {
                isSecondMax = true;
                t = ttt.getNext();
            }
        }
        NumbersWithUnitToken _next = (second || plusminus || ((t != null && t.isNewlineBefore())) ? null : _tryParse(t, addUnits, true, false));
    ...
    public static com.pullenti.ner.MetaToken _tryParseWHL(com.pullenti.ner.Token t) {
        ...
        if (txt.length() == 5 && txt.charAt(1) == 'Х' && txt.charAt(3) == 'Х') {
            ...
            return com.pullenti.ner.MetaToken._new809(t, t, nams);
        }
        com.pullenti.ner.Token t0 = t;
        ...
        if (nams == null || (nams.size() < 2)) 
            return null;
        return com.pullenti.ner.MetaToken._new809(t0, t1, nams);
    }
    ...
    public static void initialize() {
        ...
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new117("НЕ МЕНЕЕ", DiapTyp.GE);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new117("МЕНЕЕ", DiapTyp.LS);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new117("НЕ БОЛЕЕ", DiapTyp.LE);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new117("БОЛЕЕ", DiapTyp.GT);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new117("ОТ", DiapTyp.FROM);
        t.addVariant("С", false);
        t.addVariant("C", false);
        t.addVariant("НАЧИНАЯ С", false);
        t.addVariant("НАЧИНАЯ ОТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new117("ДО", DiapTyp.TO);
        t.addVariant("ПО", false);
        t.addVariant("ЗАКАНЧИВАЯ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new117("НЕ ХУЖЕ", DiapTyp.UNDEFINED);
        m_Termins.add(t);
        m_Spec = new com.pullenti.ner.core.TerminCollection();
        t = com.pullenti.ner.core.Termin._new119("ПОЛЛИТРА", .5, "литр");
        t.addVariant("ПОЛУЛИТРА", false);
        m_Spec.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПОЛКИЛО", .5, "килограмм");
        t.addVariant("ПОЛКИЛОГРАММА", false);
        m_Spec.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПОЛМЕТРА", .5, "метр");
        t.addVariant("ПОЛУМЕТРА", false);
        m_Spec.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПОЛТОННЫ", .5, "тонна");
        t.addVariant("ПОЛУТОННЫ", false);
        m_Spec.add(t);
        m_Spec.add(t);
    }

    public static NumbersWithUnitToken _new1519(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
