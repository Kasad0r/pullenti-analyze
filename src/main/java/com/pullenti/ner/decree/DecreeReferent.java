...
public class DecreeReferent extends com.pullenti.ner.Referent {
    ...
    private java.util.ArrayList<Integer> _allYears() {
        ...
        for (com.pullenti.ner.Slot s : getSlots()) {
            if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), ATTR_DATE)) {
                ...
                com.pullenti.unisharp.Outargwrapper<Integer> wrapi1084 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1085 = com.pullenti.unisharp.Utils.parseInteger(str, 0, null, wrapi1084);
                i = (wrapi1084.value != null ? wrapi1084.value : 0);
                if (inoutres1085) 
                    res.add(i);
            }
        }
    ...
    public static DecreeReferent _new1068(String _arg1) {
