...
public class DefinitionAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
            ...
            for (com.pullenti.ner.ExtOntologyItem it : kit.ontology.items) {
                if (it.referent instanceof DefinitionReferent) {
                    ...
                    if (!oh.containsKey(termin)) {
                        oh.put(termin, true);
                        onto.add(com.pullenti.ner.core.Termin._new1087(termin, termin));
                    }
                }
            }
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (!ok) 
                continue;
            java.util.ArrayList<com.pullenti.ner.ReferentToken> prs = this.tryAttach(t, glosRegime, onto, maxChar);
            if (prs == null) 
    ...
    public com.pullenti.ner.ReferentToken processReferent(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        java.util.ArrayList<com.pullenti.ner.ReferentToken> li = this.tryAttach(begin, false, null, 0);
    ...
    public java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttach(com.pullenti.ner.Token t, boolean glosRegime, com.pullenti.ner.core.TerminCollection onto, int maxChar) {
        ...
        if (t.isHiphen() || t.isCharOf(":") || ((canNextSent && t.isChar('.')))) {
            if ((t.getNext() instanceof com.pullenti.ner.TextToken) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.TextToken.class))).term, "ЭТО")) {
                ...
                java.util.ArrayList<com.pullenti.ner.ReferentToken> rt0 = this.tryAttach(t.getNext(), false, null, maxChar);
                if (rt0 != null) {
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttachEnd(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection onto, int maxChar) {
        ...
        if ((((l1.endChar - l0.endChar)) * 2) > ((r1.endChar - r0.endChar))) 
            return null;
        DefinitionReferent dr = DefinitionReferent._new1088(DefinitionKind.DEFINITION);
    ...
    private static com.pullenti.ner.MetaToken _tryAttachMiscToken(com.pullenti.ner.Token t) {
        ...
        if (t.isValue("КАК", null)) {
            ...
            if (t1 != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new809(t, t1, com.pullenti.ner.core.MiscHelper.getTextValue(t, t1, com.pullenti.ner.core.GetTextAttr.KEEPQUOTES));
        ...
        if (npt != null) {
            if (m_MiscFirstWords.tryParse(npt.noun.getBeginToken(), com.pullenti.ner.core.TerminParseAttr.NO) != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new809(t, npt.getEndToken(), npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false));
        ...
        if (t.isValue("В", null)) {
            ...
            if (npt != null) {
                if (npt.noun.isValue("СМЫСЛ", null)) {
                    com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new809(t, npt.getEndToken(), com.pullenti.ner.core.MiscHelper.getTextValue(t, npt.getEndToken(), com.pullenti.ner.core.GetTextAttr.NO));
                    res.getMorph()._setClass(com.pullenti.morph.MorphClass.NOUN);
                    return res;
                }
            }
