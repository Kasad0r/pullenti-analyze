...
public class BookLinkReferent extends com.pullenti.ner.Referent {
    ...
    public int getYear() {
        int _year;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapyear395 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres396 = com.pullenti.unisharp.Utils.parseInteger((String)com.pullenti.unisharp.Utils.notnull(this.getStringValue(ATTR_YEAR), ""), 0, null, wrapyear395);
        _year = (wrapyear395.value != null ? wrapyear395.value : 0);
        if (inoutres396) 
            return _year;
        else 
            return 0;
