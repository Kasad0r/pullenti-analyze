...
public class BookLinkAnalyzer extends com.pullenti.ner.Analyzer {
        ...
        try {
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                ...
                if (re.getNumber() != null) {
                    ...
                    boolean inoutres386 = com.pullenti.unisharp.Utils.tryGetValue(refsByNum, re.getNumber(), wrapli385);
                    li = wrapli385.value;
                    if (!inoutres386) 
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                ...
                java.util.ArrayList<BookLinkRefReferent> li;
                com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>> wrapli387 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>>();
                boolean inoutres388 = com.pullenti.unisharp.Utils.tryGetValue(refsByNum, (String)com.pullenti.unisharp.Utils.notnull(re.getNumber(), ""), wrapli387);
                li = wrapli387.value;
                if (!inoutres388) 
                    continue;
                int i;
    ...
    private static java.util.ArrayList<com.pullenti.ner.ReferentToken> tryParse(com.pullenti.ner.Token t, boolean isInLit, int maxChar) throws NumberFormatException {
        ...
        String nextNum = null;
        int nn;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapnn393 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres394 = com.pullenti.unisharp.Utils.parseInteger((num != null ? num : ""), 0, null, wrapnn393);
        nn = (wrapnn393.value != null ? wrapnn393.value : 0);
        if (inoutres394) 
