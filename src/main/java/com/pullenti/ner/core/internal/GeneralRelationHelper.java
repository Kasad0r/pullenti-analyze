...
public class GeneralRelationHelper {
    ...
    public static void refreshGenerals(com.pullenti.ner.Processor proc, com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for (com.pullenti.ner.Analyzer a : proc.getAnalyzers()) {
            ...
            for (com.pullenti.ner.Referent r : ad.getReferents()) {
                Node nod = Node._new462(r, ad);
                allRefs.add(nod);
                r.setTag(nod);
                java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>> si;
                com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapsi465 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
                boolean inoutres466 = com.pullenti.unisharp.Utils.tryGetValue(all, a.getName(), wrapsi465);
                si = wrapsi465.value;
                if (!inoutres466) 
                ...
                for (String s : strs) {
                    ...
                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli463 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                    boolean inoutres464 = com.pullenti.unisharp.Utils.tryGetValue(si, s, wrapli463);
                    li = wrapli463.value;
                    if (!inoutres464) 
    ...
    public static class Node {
        ...
        public static Node _new462(com.pullenti.ner.Referent _arg1, com.pullenti.ner.core.AnalyzerData _arg2) {
            Node res = new Node();
            res.ref = _arg1;
            res.ad = _arg2;
            return res;
