...
public class NounPhraseItem extends com.pullenti.ner.MetaToken {
        ...
        for (com.pullenti.morph.MorphBaseInfo it : getMorph().getItems()) {
            ...
            if (singleNumber && v.singleNumberValue != null) {
                if (mc != null && ((gender == com.pullenti.morph.MorphGender.NEUTER || gender == com.pullenti.morph.MorphGender.FEMINIE)) && mc.isAdjective()) {
                    com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new467(new com.pullenti.morph.MorphClass(mc), gender, com.pullenti.morph.MorphNumber.SINGULAR, com.pullenti.morph.MorphCase.NOMINATIVE, this.getMorph().getLanguage());
            ...
            if (Character.isDigit(v.normalValue.charAt(0)) && mc != null && mc.isAdjective()) {
                int val;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapval468 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres469 = com.pullenti.unisharp.Utils.parseInteger(v.normalValue, 0, null, wrapval468);
                val = (wrapval468.value != null ? wrapval468.value : 0);
                if (inoutres469) {
    ...
    public static NounPhraseItem tryParse(com.pullenti.ner.Token t, java.util.ArrayList<NounPhraseItem> items, com.pullenti.ner.core.NounPhraseParseAttr attrs) {
        ...
        for (int k = 0; k < 2; k++) {
            ...
            NounPhraseItem it = _new470(t0, t, _canBeSurname);
            ...
            for (com.pullenti.morph.MorphBaseInfo v : t.getMorph().getItems()) {
                    ...
                    if (tryAccordVariant(items, (items == null ? 0 : items.size()), v)) {
                        ...
                        if (t instanceof com.pullenti.ner.TextToken) {
                            ...
                            if (com.pullenti.unisharp.Utils.stringsEq(s, "ПРАВО") || com.pullenti.unisharp.Utils.stringsEq(s, "ПРАВА")) 
                                ...
                                ok = false;
                            else if (wf != null && ((com.pullenti.unisharp.Utils.stringsEq(wf.normalCase, "САМ") || com.pullenti.unisharp.Utils.stringsEq(wf.normalCase, "ТО")))) 
                                ok = false;
                        }
                ...
                else if (wf != null && com.pullenti.unisharp.Utils.stringsEq(((wf.normalFull != null ? wf.normalFull : wf.normalCase)), "КОТОРЫЙ")) 
                    return null;
    ...
    public static NounPhraseItem _new470(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
