    ...
    private static void addVars(String str, java.util.ArrayList<String> vars) {
        ...
        for (int k = 0; k < 2; k++) {
            ...
            for (i = 0; i < str.length(); i++) {
                String v;
                com.pullenti.unisharp.Outargwrapper<String> wrapv1093 = new com.pullenti.unisharp.Outargwrapper<String>();
                boolean inoutres1094 = com.pullenti.unisharp.Utils.tryGetValue(m_VarChars, str.charAt(i), wrapv1093);
                v = wrapv1093.value;
                if (!inoutres1094) 
                    break;
