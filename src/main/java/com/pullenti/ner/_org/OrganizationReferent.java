...
public class OrganizationReferent extends com.pullenti.ner.Referent {
    ...
    private String correctName(String name, com.pullenti.unisharp.Outargwrapper<Integer> num) {
        ...
        if (Character.isDigit(name.charAt(0)) && name.indexOf(' ') > 0) {
            int i;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapi2235 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres2236 = com.pullenti.unisharp.Utils.parseInteger(name.substring(0, 0 + name.indexOf(' ')), 0, null, wrapi2235);
            i = (wrapi2235.value != null ? wrapi2235.value : 0);
            if (inoutres2236) {
                if (i > 1) {
                    num.value = i;
            ...
            if (i >= 0 && name.charAt(i) == '.') {
                ...
                boolean inoutres2237 = com.pullenti.unisharp.Utils.parseInteger(name.substring(i + 1), 0, null, num);
                if (i > 0 && inoutres2237 && num.value > 0) {
                    if (i < 1) 
                        return null;
    ...
    public void addName(String name, boolean removeLongGovNames, com.pullenti.ner.Token t) {
        int num;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2238 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        String s = this.correctName(name, wrapnum2238);
        num = (wrapnum2238.value != null ? wrapnum2238.value : 0);
        if (s == null) {
    ...
    public void addNameStr(String name, com.pullenti.ner._org.internal.OrgItemTypeToken typ, int cou) {
        ...
        if (name == null) {
            ...
            if (typ.name != null && typ.name.length() > typ.typ.length()) {
                int num = 0;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2239 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                String s = this.correctName(typ.name, wrapnum2239);
                num = (wrapnum2239.value != null ? wrapnum2239.value : 0);
            ...
            if (typ == null || typ.isNotTyp) 
                ...
                if (typ.name != null) {
                    int num = 0;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2240 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    String ss = this.correctName(typ.name, wrapnum2240);
                    num = (wrapnum2240.value != null ? wrapnum2240.value : 0);
                    if (ss != null) {
                        this.addTypeStr(ss);
    ...
    public boolean canBeGeneralFor(com.pullenti.ner.Referent obj) {
        if (!this.canBeEqualsEx(obj, true, com.pullenti.ner.Referent.EqualType.DIFFERENTTEXTS)) 
            return false;
        ...
        if (geos1.size() == 0 && geos2.size() > 0) {
            ...
            if (getHigher() != null && (((OrganizationReferent)com.pullenti.unisharp.Utils.cast(obj, OrganizationReferent.class))).getHigher() != null) {
                if (getHigher().canBeGeneralFor((((OrganizationReferent)com.pullenti.unisharp.Utils.cast(obj, OrganizationReferent.class))).getHigher())) 
                    return true;
            }
        }
        return false;
            ...
            if (((eqNumber || eqEponyms)) && ((this.findSlot(ATTR_NAME, null, true) == null || __org.findSlot(ATTR_NAME, null, true) == null))) {
                ...
                for (java.util.Map.Entry<String, Boolean> v : getNameVars().entrySet()) {
                    if (typ == com.pullenti.ner.Referent.EqualType.DIFFERENTTEXTS && v.getValue()) 
                        continue;
                    boolean b;
                    com.pullenti.unisharp.Outargwrapper<Boolean> wrapb2242 = new com.pullenti.unisharp.Outargwrapper<Boolean>();
                    boolean inoutres2243 = com.pullenti.unisharp.Utils.tryGetValue(__org.getNameVars(), v.getKey(), wrapb2242);
                    b = (wrapb2242.value != null ? wrapb2242.value : false);
                    if (!inoutres2243) 
                        continue;
