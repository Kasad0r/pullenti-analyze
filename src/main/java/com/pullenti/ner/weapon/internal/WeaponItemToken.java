...
public class WeaponItemToken extends com.pullenti.ner.MetaToken {
    ...
    private static WeaponItemToken _TryParse(com.pullenti.ner.Token t, WeaponItemToken prev, boolean afterConj, boolean attachHigh) {
            ...
            if (res.typ == Typs.MODEL) {
                ...
                if (tok.termin.tag2 instanceof java.util.ArrayList) {
                    ...
                    for (com.pullenti.ner.core.Termin to : li) {
                        WeaponItemToken wit = _new2632(t, tok.getEndToken(), (Typs)to.tag, to.getCanonicText(), tok.getBeginToken() == tok.getEndToken());
                        res.innerTokens.add(wit);
        ...
        if (nnn != null) {
            ...
            if (tit != null) {
                WeaponItemToken res = _new2633(t, tit.getEndToken(), Typs.NUMBER);
                res.value = tit.value;
        ...
        if (((t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter() && t.chars.isAllUpper()) && (t.getLengthChar() < 4)) {
            if ((t.getNext() != null && ((t.getNext().isHiphen() || t.getNext().isChar('.'))) && (t.getNext().getWhitespacesAfterCount() < 2)) && (t.getNext().getNext() instanceof com.pullenti.ner.NumberToken)) {
                WeaponItemToken res = _new2634(t, t.getNext(), Typs.MODEL, true);
            ...
            if ((t.getNext() instanceof com.pullenti.ner.NumberToken) && !t.isWhitespaceAfter()) {
                WeaponItemToken res = _new2634(t, t, Typs.MODEL, true);
                res.value = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term;
                res._correctModel();
                return res;
            }
            if (com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "СП") && (t.getWhitespacesAfterCount() < 3) && (t.getNext() instanceof com.pullenti.ner.TextToken)) {
                ...
                if (pp != null && ((pp.typ == Typs.MODEL || pp.typ == Typs.BRAND))) {
                    WeaponItemToken res = _new2633(t, t, Typs.NOUN);
                    res.value = "ПИСТОЛЕТ";
        ...
        if (((t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter() && !t.chars.isAllLower()) && t.getLengthChar() > 2) {
            ...
            if (prev != null && ((prev.typ == Typs.NOUN || prev.typ == Typs.MODEL || prev.typ == Typs.BRAND))) 
                ...
                ok = true;
            if (ok) {
                WeaponItemToken res = _new2634(t, t, Typs.NAME, true);
                res.value = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term;
    ...
    public static void initialize() {
        ...
        t = com.pullenti.ner.core.Termin._new117("ПИСТОЛЕТ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("РЕВОЛЬВЕР", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("ВИНТОВКА", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("РУЖЬЕ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("АВТОМАТ", Typs.NOUN, 1);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("КАРАБИН", Typs.NOUN, 1);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new141("ПИСТОЛЕТ-ПУЛЕМЕТ", "ПИСТОЛЕТ-ПУЛЕМЕТ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("ПУЛЕМЕТ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("ГРАНАТОМЕТ", Typs.NOUN);
        t.addVariant("СТРЕЛКОВО ГРАНАТОМЕТНЫЙ КОМПЛЕКС", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("ОГНЕМЕТ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("МИНОМЕТ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new2649("ПЕРЕНОСНОЙ ЗЕНИТНО РАКЕТНЫЙ КОМПЛЕКС", "ПЗРК", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new2649("ПРОТИВОТАНКОВЫЙ РАКЕТНЫЙ КОМПЛЕКС", "ПТРК", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("НАРУЧНИКИ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("БРОНЕЖИЛЕТ", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("ГРАНАТА", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("ЛИМОНКА", Typs.NOUN);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new117("НОЖ", Typs.NOUN);
        m_Ontology.add(t);
        for (String s : new String[] {"МАКАРОВ", "КАЛАШНИКОВ", "СИМОНОВ", "СТЕЧКИН", "ШМАЙСЕР", "МОСИН", "СЛОСТИН", "НАГАН", "МАКСИМ", "ДРАГУНОВ", "СЕРДЮКОВ", "ЯРЫГИН", "НИКОНОВ", "МАУЗЕР", "БРАУНИНГ", "КОЛЬТ", "ВИНЧЕСТЕР"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new117(s, Typs.BRAND));
        }
        for (String s : new String[] {"УЗИ"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new117(s, Typs.NAME));
        }
        t = com.pullenti.ner.core.Termin._new2658("ТУЛЬСКИЙ ТОКАРЕВА", "ТТ", "ТТ", Typs.MODEL);
        li = new java.util.ArrayList<com.pullenti.ner.core.Termin>();
        li.add(com.pullenti.ner.core.Termin._new117("ПИСТОЛЕТ", Typs.NOUN));
        li.add(com.pullenti.ner.core.Termin._new117("ТОКАРЕВ", Typs.BRAND));
        t.tag2 = li;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new2658("ПИСТОЛЕТ МАКАРОВА", "ПМ", "ПМ", Typs.MODEL);
        li = new java.util.ArrayList<com.pullenti.ner.core.Termin>();
        li.add(com.pullenti.ner.core.Termin._new117("ПИСТОЛЕТ", Typs.NOUN));
        li.add(com.pullenti.ner.core.Termin._new117("МАКАРОВ", Typs.BRAND));
        t.tag2 = li;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new2658("ПИСТОЛЕТ МАКАРОВА МОДЕРНИЗИРОВАННЫЙ", "ПММ", "ПММ", Typs.MODEL);
        li = new java.util.ArrayList<com.pullenti.ner.core.Termin>();
        li.add((tt = com.pullenti.ner.core.Termin._new117("ПИСТОЛЕТ", Typs.NOUN)));
        tt.addVariant("МОДЕРНИЗИРОВАННЫЙ ПИСТОЛЕТ", false);
        li.add(com.pullenti.ner.core.Termin._new117("МАКАРОВ", Typs.BRAND));
        t.tag2 = li;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new2658("АВТОМАТ КАЛАШНИКОВА", "АК", "АК", Typs.MODEL);
        li = new java.util.ArrayList<com.pullenti.ner.core.Termin>();
        li.add(com.pullenti.ner.core.Termin._new117("АВТОМАТ", Typs.NOUN));
        li.add(com.pullenti.ner.core.Termin._new117("КАЛАШНИКОВ", Typs.BRAND));
        t.tag2 = li;
        m_Ontology.add(t);
    }

    public static WeaponItemToken _new2632(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Typs _arg3, String _arg4, boolean _arg5) {
    ...
    public static WeaponItemToken _new2633(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Typs _arg3) {
        WeaponItemToken res = new WeaponItemToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static WeaponItemToken _new2634(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Typs _arg3, boolean _arg4) {
        WeaponItemToken res = new WeaponItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.isDoubt = _arg4;
        return res;
