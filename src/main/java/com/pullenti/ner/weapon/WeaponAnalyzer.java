                        ...
                        if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_MODEL)) {
                            ...
                            for (int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    ...
                                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2670 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                                    boolean inoutres2671 = com.pullenti.unisharp.Utils.tryGetValue(objsByModel, mod, wrapli2670);
                                    li = wrapli2670.value;
                                    if (!inoutres2671) 
                            ...
                            objByNames.add(com.pullenti.ner.core.Termin._new117(s.getValue().toString(), rt.referent));
                    }
                }
            }
        }
